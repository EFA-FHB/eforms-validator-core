...
public interface ValidatorService {
   ...
   *
   * @param validationRequestDTO the validation request DTO containing the business document and
   ...
   *
   * @param validationRequestDTO the business document validation request DTO containing the
   *     business document and validation parameters
