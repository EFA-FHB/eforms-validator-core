<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="codelists">
  ...
  <rule
    ...
    <!--Codes from urn:xeinkauf:eforms-de:codelist:buyer-contracting-type in version 1.0.1 derived from  https://github.com/OP-TED/eForms-SDK/blob/1.7.0/codelists/buyer-contracting-type.gc-->
  ...
  <rule
    ...
    <!--Codes from urn:xeinkauf:eforms-de:codelist:eforms-buyer-legal-type in version 1.0.0 derived from  https://github.com/OP-TED/eForms-SDK/blob/1.7.0/codelists/buyer-legal-type_eforms-buyer-legal-type.gc-->
...
<!--Codes from urn:xeinkauf:eforms-de:codelist:exclusion-ground in version 1.0.1 derived from  https://github.com/OP-TED/eForms-SDK/blob/1.7.0/codelists/criterion_exclusion-ground.gc-->
    <assert id="CL-DE-BT-67"
      test=". = ('bankr-nat','bankruptcy','corruption','cred-arran','crime-org','distorsion','envir-law','finan-laund','fraud','human-traffic','insolvency','labour-law','liq-admin','misrepresent','nati-ground','partic-confl','prep-confl','prof-misconduct','sanction','socsec-law','socsec-pay','susp-act','tax-pay','terr-offence')"
      role="error"
  ...
  <rule
   ...
   <!--Codes from urn:xeinkauf:eforms-de:codelist:economic-operator-size:v1.0 in version 1.0.0 derived from  https://github.com/OP-TED/eForms-SDK/blob/1.7.0/codelists/economic-operator-size.gc--><assert id="CL-DE-BT-165"
        test=". = ('large','medium','micro','small')"
        role="error">[CL-DE-BT-165] Value must be one from codelist urn:xeinkauf:eforms-de:codelist:economic-operator-size:v1.0.</assert>
...
<!--Codes from urn:xeinkauf:eforms-de:codelist:missing-info-submission in version 1.0.0 derived from  https://github.com/OP-TED/eForms-SDK/blob/1.7.0/codelists/missing-info-submission.gc--><assert id="CL-DE-BT-771"
        test=". = ('late-all','late-some','late-none')"
        role="error">[CL-DE-BT-771] Value must be one from codelist urn:xeinkauf:eforms-de:codelist:missing-info-submission.</assert>
  ...
  <rule context="$ROOT-NODE/cac:TenderingProcess/cbc:ProcedureCode">
    ...
    <!--Codes from urn:xeinkauf:eforms-de:codelist:procurement-procedure-type in version 1.0.1 derived from  https://github.com/OP-TED/eForms-SDK/blob/1.7.0/codelists/procurement-procedure-type.gc-->
  <assert id="CL-DE-BT-105"
        test=". = ('comp-dial','innovation','neg-w-call','us-neg-w-call','neg-wo-call','us-neg-wo-call','open','us-open','oth-mult','oth-single','us-free-tw','us-free-no-tw','us-hhr','restricted','us-res-tw','us-res-no-tw')"
        role="error">[CL-DE-BT-105] Value must be one from codelist urn:xeinkauf:eforms-de:codelist:procurement-procedure-type.</assert>
...
<!--Codes from urn:xeinkauf:eforms-de:codelist:gpp-criteria in version 1.0.1 derived from  https://github.com/OP-TED/eForms-SDK/blob/1.7.0/codelists/gpp-criteria.gc-->
...
<!--Codes from urn:xeinkauf:eforms-de:codelist:eforms-de-specific-legal-basis in version 1.1.0 derived from  https://github.com/OP-TED/eForms-SDK/blob/1.7.0/codelists/legal-basis_eforms-legal-basis.gc-->
    <assert id="CL-DE-BT-01"
        ...
        role="error">[CL-DE-BT-01] Value must be one from codelist urn:xeinkauf:eforms-de:codelist:eforms-de-specific-legal-basis.</assert>

  </rule>

  <rule
    context="$EXTENSION-NODE/efac:NoticeResult/efac:LotResult/efac:ReceivedSubmissionsStatistics/efbc:StatisticsCode">
    <!--Codes from urn:xeinkauf:eforms-de:codelist:received-submission-type:v1.0 in version 1.0.0 derived from  https://github.com/OP-TED/eForms-SDK/blob/1.7.0/codelists/received-submission-type.gc-->
    <assert id="CL-DE-BT-760"
        ...
        role="error">[CL-DE-BT-760] Value must be one from codelist urn:xeinkauf:eforms-de:codelist:received-submission-type:v1.0.</assert>
  </rule>
  ...
  <rule
    ...
    <!--Codes from urn:xeinkauf:eforms-de:codelist:social-objective in version 1.0.0 derived from  https://github.com/OP-TED/eForms-SDK/blob/1.7.0/codelists/social-objective.gc-->
    <assert id="CL-DE-BT-775"
        test=". = ('acc-all','et-eq','gen-eq','hum-right','opp','other','iao-core','work-cond')"
        role="error">[CL-DE-BT-775] Value must be one from codelist urn:xeinkauf:eforms-de:codelist:social-objective.</assert>
